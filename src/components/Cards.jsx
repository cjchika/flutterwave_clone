    ...
    <>
      <section className="bg-cardDarkBG">
        <div className="xl:mx-[120px] md:my-[65px] lg:my-[90px] max-w-[120.6rem] flex flex-col items-center justify-start text-center">
          ...
          <div className="flex flex-col md:flex-row w-full justify-center relative ">
            <div className="text-white bg-[url('../assets/Images/box.png')] z-[1]  bg-[#313131] rounded-[1.6rem] shadow-md overflow-hidden text-left p-14">
              <h6 className="text-[1.2rem] mb-[1.5rem]">
              ...
              <p className="text-[1rem] leading-[1.5rem]">
                ...
                able to issue a specific virtual card for all your Instagram ads
                to better manage and account for that expense within your
                business.
              </p>
            </div>
            <div className="text-white z-[2] bg-[url('../assets/Images/box.png')] my-[3rem] md:my-0 bg-[#313131] rounded-[1.6rem] shadow-md overflow-hidden text-left p-14">
              <h6 className="text-[1.2rem] mb-[1.5rem]">New revenue lines</h6>
              <p className="text-[1rem] leading-[1.5rem]">
            ...
            <div className=" text-white z-[2] bg-[url('../assets/Images/box.png')] bg-[#313131] rounded-[1.6rem] shadow-md overflow-hidden text-left p-14">
              <h6 className="text-[1.2rem] mb-[1.5rem]">
